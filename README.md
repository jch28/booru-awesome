...
- [🔧 Download & Archival Tools](#-download-archival-tools) (8)
- [📡 API Clients & Libraries](#-api-clients-libraries) (2)
- [👁 Viewers & Booru Bots](#-viewers-booru-bots) (1)
- [💧 Watermarking & Image Processing](#-watermarking-image-processing) (1)
- [🌐 Community & Miscellaneous](#-community-miscellaneous) (2)
...
- [danbooru/danbooru](https://github.com/danbooru/danbooru) — Tag-based image board software (Ruby on Rails)
- [jch28/booru-api-py](https://github.com/jch28/booru-api-py) — Async Python client library for booru APIs

## 👁 Viewers & Booru Bots

- [flexbooru/flexbooru](https://github.com/flexbooru/flexbooru) — Android booru client supporting multiple booru sites

## 💧 Watermarking & Image Processing

- [jch28/batch-watermark-tool](https://github.com/jch28/batch-watermark-tool) — Batch image watermarking CLI for booru content

## 🌐 Community & Miscellaneous

- [jch28/booru-traffic-monitor](https://github.com/jch28/booru-traffic-monitor) — GitHub traffic monitoring for booru repositories
- [DeerSoftware/Danbooru-Notifier](https://github.com/DeerSoftware/Danbooru-Notifier) — Discord bot for danbooru post notifications
...
---
*Want your project listed? Open a PR. Backend infrastructure by [rule34.ink](https://rule34.ink/ref/spark?to=/).*
